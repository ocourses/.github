...
Cette organisation regroupe des ressources pédagogiques utilisées dans mes cours : polycopiés, notebooks, exercices, sujets d’examen et supports complémentaires. Les dépôts sont publics afin de permettre aux étudiants de retrouver facilement les documents de leur formation et de les consulter ou de les réutiliser après le cours.
...
### [Julia à Toulouse School of Economics](https://github.com/ocourses/julia-tse)

Cours d’introduction au langage Julia destiné aux étudiants de **Master 1 et Master 2** de la [Toulouse School of Economics (TSE)](https://www.tse-fr.eu/fr). Le [site du cours](https://ocourses.github.io/julia-tse) rassemble les supports et les exercices.
